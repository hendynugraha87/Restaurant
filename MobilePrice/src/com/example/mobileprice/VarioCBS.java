...
public class VarioCBS extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        pic = new int [] {
            ...
            adapt = new Vario_125_CBS_Adapter(getActivity(), pic, label_pic);
            vp.setAdapter(adapt);
            vp.setCurrentItem(0);
	...
	public class Vario_125_CBS_Adapter extends PagerAdapter{
		...
		public Vario_125_CBS_Adapter(Context context, int [] pic, String [] label_pic){
		...
		public Object instantiateItem(ViewGroup container, final int pos){
			...
			iv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(current_pos==0){
						MessageMobilePrice("Vario 125 CBS", "Vario 125 CBS");
