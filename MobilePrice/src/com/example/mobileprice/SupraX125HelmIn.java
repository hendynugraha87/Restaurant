...
public class SupraX125HelmIn extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        pic = new int [] {
            ...
            adapt = new SupraX_125_HI_Adapter(getActivity(), pic, label_pic);
            vp.setAdapter(adapt);
            vp.setCurrentItem(0);
	...
	public class SupraX_125_HI_Adapter extends PagerAdapter{
		...
		public SupraX_125_HI_Adapter(Context context, int [] pic, String [] label_pic){
		...
		public Object instantiateItem(ViewGroup container, final int pos){
			...
			iv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(current_pos==0){
						MessageMobilePrice("Supra X 125 Helm In PGM-FI", "Supra X 125 Helm In PGM-FI");
