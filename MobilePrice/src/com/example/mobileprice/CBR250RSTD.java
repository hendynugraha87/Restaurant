...
public class CBR250RSTD extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        pic = new int [] {
            	R.drawable.cbr250rstd1,
            	R.drawable.cbr250rstd2
            };
            ...
            adapt = new CBR_250R_STD_Adapter(getActivity(), pic, label_pic);
            vp.setAdapter(adapt);
            vp.setCurrentItem(0);
	...
	public class CBR_250R_STD_Adapter extends PagerAdapter{
		...
		public CBR_250R_STD_Adapter(Context context, int [] pic, String [] label_pic){
		...
		public Object instantiateItem(ViewGroup container, final int pos){
			...
			iv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(current_pos==0){
						MessageMobilePrice("CBR 250R STD", "CBR 250R STD");
