...
public class BeatFICW extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        pic = new int [] {
            ...
            adapt = new Beat_FI_CW(getActivity(), pic, label_pic);
            vp.setAdapter(adapt);
            vp.setCurrentItem(0);
	...
	public class Beat_FI_CW extends PagerAdapter{
		...
		public Beat_FI_CW(Context context, int [] pic, String [] label_pic){
		...
		public Object instantiateItem(ViewGroup container, final int pos){
			...
			iv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(current_pos==0){
						MessageMobilePrice("Beat FI CW", "Beat FI CW");
