...
public class CBR150R extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        pic = new int [] {
            ...
            adapt = new CBR_150_R(getActivity(), pic, label_pic);
            vp.setAdapter(adapt);
            vp.setCurrentItem(0);
	...
	public class CBR_150_R extends PagerAdapter{
		...
		public CBR_150_R(Context context, int [] pic, String [] label_pic){
		...
		public Object instantiateItem(ViewGroup container, final int pos){
			...
			iv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(current_pos==0){
						MessageMobilePrice("CBR 150 R", "CBR 150 R");
