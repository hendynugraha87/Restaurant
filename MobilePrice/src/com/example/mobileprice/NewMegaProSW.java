...
public class NewMegaProSW extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        pic = new int [] {
            ...
            adapt = new New_Honda_Mega_Pro_SW_Adapter(getActivity(), pic, label_pic);
            vp.setAdapter(adapt);
            vp.setCurrentItem(0);
	...
	public class New_Honda_Mega_Pro_SW_Adapter extends PagerAdapter{
		...
		public New_Honda_Mega_Pro_SW_Adapter(Context context, int [] pic, String [] label_pic){
		...
		public Object instantiateItem(ViewGroup container, final int pos){
			...
			iv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(current_pos==0){
						MessageMobilePrice("New Honda Mega Pro SW", "New Honda Mega Pro SW");
