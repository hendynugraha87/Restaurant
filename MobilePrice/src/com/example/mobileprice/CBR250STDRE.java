...
public class CBR250STDRE extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        pic = new int [] {
            ...
            adapt = new CBR_250R_STD_RE_Adapter(getActivity(), pic, label_pic);
            vp.setAdapter(adapt);
            vp.setCurrentItem(0);
	...
	public class CBR_250R_STD_RE_Adapter extends PagerAdapter{
		...
		public CBR_250R_STD_RE_Adapter(Context context, int [] pic, String [] label_pic){
		...
		public Object instantiateItem(ViewGroup container, final int pos){
			...
			iv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(current_pos==0){
						MessageMobilePrice("CBR 250R STD Repsol Edition", "CBR 250R STD Repsol Edition");
					}
				}
			});
