...
public class CBR250RABSBK extends Fragment {
	...
	public class CBR_250R_ABS_RE extends PagerAdapter{
		...
		public CBR_250R_ABS_RE(Context context, int [] pic, String [] label_pic){
		...
		public Object instantiateItem(ViewGroup container, final int pos){
			...
			iv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(current_pos==0){
						MessageMobilePrice("CBR 250R ABS Black Knight", "CBR 250R ABS Black Knight");
					}
				}
			});
